...
use App\Database\Repository\Shoptet\OrderBillingAddressRepository;

use App\UI\Address\AddressInterface;
use Doctrine\ORM\Mapping as ORM;

#[Orm\Entity(repositoryClass: OrderBillingAddressRepository::class)]
#[ORM\Table(name: 'sf_order_billing_address')]
#[ORM\HasLifecycleCallbacks]
class OrderBillingAddress implements AddressInterface
{
	use Attributes\TId;
